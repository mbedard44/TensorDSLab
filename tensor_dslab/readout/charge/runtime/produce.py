...
import torch
from tensor_core import CounterRng, RngElements
...
def produce_charge(
    ...
    *,
    ...
    stochastic = (
        (runtime.dark is not None and runtime.dark.mean != 0.0)
        or runtime.timing_jitter is not None
        or runtime.correlated_avalanches is not None
        or (
            runtime.smearing is not None
            and runtime.smearing.represented_sigma != 0.0
        )
    )
    elements = (
