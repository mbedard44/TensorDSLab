...
`0.13.0`; closed Maintenance 6 fixes the public physical-configuration
boundary. The complete scientific
...
`0257fb477ee04556ebbe26351123ae610b5d7925`. It selects exact Pint `0.25.3`
for public physical Config values and the compact SampleAxis convenience
...
`e5cc70adddaed357298e3e3bc4d95df78d3a55b7`. Its exact
