...
`ba4f3408bf6b5cbd34d6736741026297b3e05c19`, rebaselining the package to exact
TensorCore `0.21.0`. Its accepted architecture is literal kernel geometry and
quantities,
...
`e5cc70adddaed357298e3e3bc4d95df78d3a55b7` under
...
tree `5c76122b25d17b9fe0b796618613d7bff0b102c1`, against published TensorCore
...
finite-window outputs are retired without reservation. The accepted local
evidence is CPU-only; integrated CUDA, performance, compatibility,
publication, release, and deployment remain separately authorized.
